<!-- Insert Modal -->
<div wire:ignore.self class="modal fade" id="fotoModal" tabindex="-1" aria-labelledby="fotoModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header text-bg-info">
                <h5 class="modal-title" id="fotoModalLabel">Cargar Foto</h5>
                ...
                <div class="modal-footer">
                    ...
                    <div wire:loading wire:target='cargarFoto' class="m-2">
                        Enviando...
                      </div>
                    </form>
                </div>
