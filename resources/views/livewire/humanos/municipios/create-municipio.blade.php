  <!-- Modal -->
  <div wire:ignore.self class="modal fade" id="crearMunicipio" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            @endif
            <form wire:submit.prevent="createCounty">
              <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-5">
                      ...
                      @error('estado_id')<br><small style="color: red">{{ $message }}</small>
                      @enderror
                    </div>
                  </div>  
        </div>
