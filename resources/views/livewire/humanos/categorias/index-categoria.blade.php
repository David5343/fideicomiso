<div class="card-body p-3">
    ...
    <thead>
        <tr>
            ...
            <th scope="col">Plazas Autorizadas</th>
            ...
            @foreach ($lista as $item)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ url('humanos/categorias/'.$item->id .'/edit')}}" class="btn btn-warning btn-sm">
                            <i class="bi bi-pencil-square"></i>
                        </a>
                    </td>
                    <td>
                        <form action="{{ url('humanos/categorias/'.$item->id)}}" method="post">
                            @method('DELETE')
                            @csrf
