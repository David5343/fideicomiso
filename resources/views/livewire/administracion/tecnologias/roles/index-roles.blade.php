            ...
            @foreach ($lista as $item)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ url('administracion/tecnologias/roles/'.$item->id .'/edit')}}" class="btn btn-warning btn-sm">
                            <i class="bi bi-pencil-square"></i>
                        </a>
                    </td>
                    <td>
                        <form action="{{ url('administracion/tecnologias/roles/'.$item->id)}}" method="post">
                            @method('DELETE')
                            @csrf
