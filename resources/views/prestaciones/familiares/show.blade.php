                ...
                <div class="card-body p-0">
                  <ul class="list-group list-group-flush rounded-3">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                      ...
                      <p class="mb-0">@if($familiar->insured->file_number){{$familiar->insured->file_number}}@endif</p>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                      <p class="mb-0"><strong>Nombre</strong></p>
                      <p class="mb-0">@if($familiar->insured->last_name_1){{$familiar->insured->last_name_1.' '.$familiar->insured->last_name_2.' '.$familiar->insured->name}}@endif</p>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                      <p class="mb-0"><strong>Fecha de Nacimiento</strong></p>
                      <p class="mb-0">@if($familiar->insured->birthday){{$familiar->insured->birthday}}@endif</p>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                      <p class="mb-0"><strong>RFC</strong></p>
                      <p class="mb-0">@if($familiar->insured->rfc){{$familiar->insured->rfc}}@endif</p>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                      <p class="mb-0"><strong>CURP</strong></p>
                      <p class="mb-0">@if($familiar->insured->curp){{$familiar->insured->curp}}@endif</p>
                    </li>
                  </ul>
                </div>
              </div> 
