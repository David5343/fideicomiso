...
@section('content')
<p class="text-end">
    <a href="{{ route('prestaciones.titulares.create') }}" class="btn btn-primary" role="button">Crear Titular</a>
    <a href="{{ route('prestaciones.titulares.index') }}" class="btn btn-primary" role="button">Lista de Titulares</a>
</p>
