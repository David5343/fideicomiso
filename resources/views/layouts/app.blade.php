...
<body>
    <div id="app" class="container">
      <img src="{{asset('img/Banner.jpg')}}" class="rounded img-fluid" width="1296px">
        <nav class="navbar navbar-dark bg-dark sticky-top rounded">
            <div class="container">        
                ...
                <div class="offcanvas-body">
                  <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu dropdown-menu-primary">
                        <li><h6 class="dropdown-header">Catalogos</h6></li>
                        <li><a class="dropdown-item" href="{{route('humanos.areas.index')}}">Dependencias</a></li>
                        <li><a class="dropdown-item" href="{{route('humanos.areas.index')}}">Subdependencias</a></li>
                        <li>
                          <hr class="dropdown-divider">
                        </li>
                      </ul>
        ...
        <main class="py-1">
            @yield('content')
            <footer class="container py-3 my-4 bg-primary text-bg-primary p-3 fs-5 rounded">
              ...
              <p class="text-center text-body-primary">Tecnologías de la Información</p>
            </footer>
        </main>
    </div>
</body>
