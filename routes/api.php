...
use App\Http\Controllers\Api\Prestaciones\CredentialBeneficiaryController;
...
Route::post('/prestaciones/credencialfamiliar/guardar',[CredentialBeneficiaryController::class, 'store']);
Route::get('/prestaciones/credencialfamiliar/{id}',[CredentialBeneficiaryController::class,'show']);
});
